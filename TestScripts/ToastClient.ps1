Function Connect-TCPClient
{
    ...
    Try 
    {
        ...
        [System.IO.StreamReader] $reader = [System.IO.StreamReader]::($stream)
        [System.IO.StreamWriter] $writer = [System.IO.StreamWriter]::($stream)
...
Connect-TCPClient 127.0.0.1 4444